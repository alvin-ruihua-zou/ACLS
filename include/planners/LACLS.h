#ifndef LACLS_PLANNER_H_
#define LACLS_PLANNER_H_
...
/**
 * @class LACLS
 * @brief Implements the Attractor-based Constrained Least-cost Search (LACLS) algorithm for pathfinding.
 */
class LACLS
{
public:
    ...
    struct SearchState : public heap_element
    {
        ...
        int bp_idx;                                   ///< Backpointer index.
        int bp_attr_id;                               ///< Backpointer attractor ID.
    };
    ...
    /**
     * @brief Constructor for the LACLS class.
     * @param space Pointer to the discrete space environment.
     */
    LACLS(DiscreteSpaceInformation *space);

    /**
     * @brief Destructor for the LACLS class.
     */
    ~LACLS();
    ...
    /**
     * @brief Sets the distance threshold for attractors.
     * @param w The distance threshold value.
     */
    inline void setDistThresh(int w)
    {
        m_dist_thresh = w;
    }
...
private:
    ...
    intrusive_heap<SearchState, SearchStateCompare> m_open; ///< Open list for LACLS search.
    ...
    int m_dist_thresh;                                      ///< Distance threshold for attractors.
